		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-3 col-xs-2">
					<div id="fh5co-logo"><a href="indexConnecte.php">GEOCONCEPT</a></div></br>
                            ...
                            if (!empty($userinfo['avatar'])) {
                                ?>
                            <div style="margin-right: 300px; "><center><a href="profile.php"><img src="membres/avatars/<?php echo $userinfo['avatar'];?>" style="padding-left: 35%; border-radius: 50%;  width: 50px; height: 50px;"/></a></center></div>
                            <?php
                            }
                            else {
                                ?>
                ...
                <div class="input-group" style="padding-left: 50px;">
                    	<a href="logout.php" class="deja2" style="color: #888;">Log out</a></div>
				</div>
